...
def main():
    ...
    # Write
    save_folder_path = os.path.join('./saved/backdoored_model', 'poison_rate_'+str(arg.poison_rate), 'noTrans', arg.dataset, arg.model, arg.trigger_type)
    ...
    for epoch in tqdm(range(start_epoch, arg.epochs)):
        train_loss, train_acc, train_asr, train_racc = train_epoch(arg, trainloader, model, optimizer, scheduler, criterion, epoch)
